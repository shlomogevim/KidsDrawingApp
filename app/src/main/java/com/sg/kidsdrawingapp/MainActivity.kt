...
class MainActivity : AppCompatActivity() {
   ...
   drawingView = findViewById(R.id.drawig_view_layout)
        //   bruchButton = findViewById(R.id.ib_action_buttons)
        linearlayoutPaintColor = findViewById(R.id.ll_paint_colors)
     ...
     withContext(Dispatchers.IO){
         if (mBitmap!=null){
             try {
                 ...
                 val fName=File(getExternalFilesDir(null),"MyPaint_"+(System.currentTimeMillis()/1000)+".jpg")
              ...
              /*   val f=File(externalCacheDir?.absoluteFile.toString()+File.separator+"KidDrawingApp"+System.currentTimeMillis()/1000+".png")
                 ...
                 runOnUiThread {
                     ...
                     if (result.isNotEmpty()){
                       ...
                       shareImage(FileProvider.getUriForFile(baseContext,"com.sg.kidsdrawingapp.fileprovider",fName))
